...
* @{
*/
#define PRODUCT_KEY "d67c297ff3fd49a3ac5ff55d857b7eec"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "17c8e5d9b7b14e6fb81066c7d69dc583"
...
* @{
*/
#define All_Led_BYTEOFFSET                    0
#define All_Led_BITOFFSET                     0
#define All_Led_LEN                           1
#define auto_rain_BYTEOFFSET                    0
#define auto_rain_BITOFFSET                     1
#define auto_rain_LEN                           1
#define auto_hum_tem_BYTEOFFSET                    0
#define auto_hum_tem_BITOFFSET                     2
#define auto_hum_tem_LEN                           1
#define handle_humidity_Temp_BYTEOFFSET                    0
#define handle_humidity_Temp_BITOFFSET                     3
#define handle_humidity_Temp_LEN                           2
#define Rain_BYTEOFFSET                    5
#define Rain_BITOFFSET                     0
#define Rain_LEN                           2

#define Red_Led_RATIO                         1
#define Red_Led_ADDITION                      0
#define Red_Led_MIN                           0
#define Red_Led_MAX                           100
#define Green_Led_RATIO                         1
#define Green_Led_ADDITION                      0
#define Green_Led_MIN                           0
#define Green_Led_MAX                           100
#define Blue_Led_RATIO                         1
#define Blue_Led_ADDITION                      0
#define Blue_Led_MIN                           0
#define Blue_Led_MAX                           100
#define window_open_rangle_RATIO                         9
#define window_open_rangle_ADDITION                      0
#define window_open_rangle_MIN                           0
#define window_open_rangle_MAX                           15
...
typedef enum
{
    handle_humidity_Temp_VALUE0 = 0,//关闭
    handle_humidity_Temp_VALUE1 = 1,//加温湿
    handle_humidity_Temp_VALUE2 = 2,//减温湿
    handle_humidity_Temp_VALUE_MAX,
} handle_humidity_Temp_ENUM_T;
typedef enum
{
    Rain_VALUE0 = 0,//无雨
    Rain_VALUE1 = 1,//小雨
...
typedef enum
{
  ...
  EVENT_auto_rain,
  EVENT_auto_hum_tem,
  EVENT_handle_humidity_Temp,
  EVENT_Red_Led,
  EVENT_Green_Led,
  EVENT_Blue_Led,
  EVENT_window_open_rangle,
...
typedef struct {
  bool valueAll_Led;
  bool valueauto_rain;
  bool valueauto_hum_tem;
  uint32_t valuehandle_humidity_Temp;
  uint32_t valueRed_Led;
  uint32_t valueGreen_Led;
  uint32_t valueBlue_Led;
  uint32_t valuewindow_open_rangle;
  uint32_t valueRain;
...
typedef struct {
  uint8_t flagAll_Led:1;
  uint8_t flagauto_rain:1;
  uint8_t flagauto_hum_tem:1;
  uint8_t flaghandle_humidity_Temp:1;
  uint8_t flagRed_Led:1;
  uint8_t flagGreen_Led:1;
  uint8_t flagBlue_Led:1;
  uint8_t flagwindow_open_rangle:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valuewindow_open_rangle;
} attrVals_t;
